...
if AliNight:get(Night.."Abs:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Ali_Night(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
AliNight:setex(Night..'Abs:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
