...
if Manager(msg) then
if AliNight:get(Night.."Abs:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
AliNight:set(Night.."Abs:ProNames:Txt"..msg.chat_id_,Txt)
else
...
AliNight:set(Night.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if AliNight:get(Night.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = AliNight:get(Night.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = AliNight:get(Night.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if AliNight:get(Night.."Abs:Lock:ProNames"..msg.chat_id_) and AliNight:get(Night.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..AliNight:get(Night.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
AliNight:srem(Night..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = AliNight:get(Night.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = AliNight:get(Night.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
AliNight:del(Night.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
AliNight:set(Night.."Abs:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
AliNight:del(Night.."Abs:Lock:ProNames"..msg.chat_id_)
end
end
