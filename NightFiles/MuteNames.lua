...
if AliNight:get(Night.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
AliNight:sadd(Night.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
AliNight:srem(Night.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
AliNight:del(Night.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = AliNight:smembers(Night.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and AliNight:get(Night.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
NightName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if NightName then 
NightNames = AliNight:smembers(Night.."Abs:Mute:Names"..msg.chat_id_) or ""
if NightNames and NightNames[1] then 
for i=1,#NightNames do 
if NightName:match("(.*)("..NightNames[i]..")(.*)") then 
...
AliNight:set(Night.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
AliNight:del(Night.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
