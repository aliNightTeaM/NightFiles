...
if devali:get(Night.."ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
devali:sadd(Night.."ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and devali:get(Night.."ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
NightName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if NightName then 
NightNames = devali:smembers(Night.."ali:Mute:Names"..msg.chat_id_) or ""
...
devali:set(Night.."ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
devali:del(Night.."ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
